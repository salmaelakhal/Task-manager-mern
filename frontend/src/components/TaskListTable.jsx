...
const TaskListTable = ({ tableData }) => {
  ...
  const getPriorityBadgeColor = (priority) => {
    switch (priority) {
      ...
      case "Low":
        return "bg-green-100 text-green-500 border border-greeb-200";
      default:
        return "bg-gray-100 text-gray-500 border border-gray-200";
    }
  };
      ...
      <table className="min-w-full">
        <thead>
          <tr className="text-left">
            <th className="py-3 px-4 text-gray-800 font-medium txet-[13px]">Name</th>
            <th className="py-3 px-4 text-gray-800 font-medium txet-[13px]">Status</th>
            <th className="py-3 px-4 text-gray-800 font-medium txet-[13px]">Priotity</th>
            <th className="py-3 px-4 text-gray-800 font-medium txet-[13px] hidden md:table-cell">Created On</th>
          </tr>
        </thead>
